    ...
    try:
        ...
        if variables['BUCKET']['value'] == "" and variables['WORDLIST']['value'] != "":
            ...
            for buck in file.readlines():
                buck = buck.replace("\n", "")
                try:
                    s3_url = "http://{0}.storage.googleapis.com".format(buck)
                    ...
                    if response.status_code == 200:
                        ...
                        objects["gcp_bucket_name"] = buck
                        objects["gcp_bucket_policy_status"] = "Public"
                        objects["gcp_bucket_objects"] = res
                        ...
                        objects["gcp_bucket_name"] = buck
                        objects["gcp_bucket_policy_status"] = "Private"
            ...
            for s3object in buckets:
                try:
                    ...
                    models.GCPBucket.objects().get(gcp_bucket_name=s3object['gcp_bucket_name']).update(
                        **s3object)

                except flask_mongoengine.DoesNotExist:
                    # models.AzureADUsage(**saved_json).save()
                    models.GCPBucket(**s3object).save()
                except:
                    pass

            return {"gcp_bucket_name": buckets}, 200
